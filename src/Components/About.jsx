                ...
                <div className="about-main">
                    ...
                    <div className='container mt-10'>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center mb-8">
                            ...
                            <div className='text-center lg:text-left'>
                                <h1 className={`text-3xl lg:text-5xl mb-8 font-sans ${theme ==='dark'?'text-blue-500':'text-black'} `}>Dream until your dream comes true</h1>
